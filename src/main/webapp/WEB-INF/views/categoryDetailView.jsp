...
<head>
  ...
  <title>Thông tin loại #${requestScope.category.id}</title>
</head>
...
<section class="section-content">
  <div class="container">
    <header class="section-heading py-4">
      <h3 class="section-title">Thông tin loại</h3>
    ...
    <div class="card mb-5">
      <div class="card-body">
        <dl class="row">
          ...
          <dt class="col-md-3">Mô tả loại</dt>
          <dd class="col-md-9">${requestScope.category.description}</dd>

          <dt class="col-md-3">Hình ảnh</dt>
          <dd class="col-md-9">
            <c:choose>
