...
<section class="section-content">
  <div class="container">
    <header class="section-heading py-4">
      <h3 class="section-title">Sửa loại</h3>
    ...
    <main class="row mb-5">
      <form class="col-lg-6" method="POST" action="${pageContext.request.contextPath}/admin/categoryManager/update"
        ...
        <div class="mb-3">
          <label for="category-name" class="form-label">Tên loại <span class="text-danger">*</span></label>
          <input type="text"
        ...
        <div class="mb-3">
          <label for="category-imageName" class="form-label d-block">Hình ảnh</label>
          <c:choose>
