...
public class ChangePasswordServlet extends HomeServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean currentPasswordMatches = HashingUtils.matches(values.get("currentPassword"), user.getPassword());
        boolean newPasswordEqualsNewPasswordAgain = values.get("newPassword").equals(values.get("newPasswordAgain"));

        if (currentPasswordMatches && newPasswordEqualsNewPasswordAgain) {
